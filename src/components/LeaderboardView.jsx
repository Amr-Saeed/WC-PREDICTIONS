...
export default function LeaderboardView({ leaderboard, currentUserId, onSync }) {
  return (
    <div>
      ...
      {leaderboard.length === 0 ? (
        <div className="empty-state">
          No players yet. Predictions you make will show up here once others join too.
        </div>
      ) : (
        <>
          <div className="legend">
            ...
            <span>
              <i style={{ background: "#e8c468" }}></i>+1 bonus — correct Extra Time call
            </span>
            <span>
              <i style={{ background: "#e5615a" }}></i>+2 bonus — correct Penalties call
            </span>
          </div>
